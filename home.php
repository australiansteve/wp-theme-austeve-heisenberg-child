...
?>
	<div class="grid-x post-archive-post" style="margin-bottom: 1em; border-bottom: 3px solid <?php echo $highlightColor;?>; padding-bottom: 1em;">
...
<?php
		the_excerpt();
?>
			<a class="button" href="<?php echo get_the_permalink()?>" style="background-color:<?php echo $highlightColor; ?>">Read Story</a>
		</div>
	</div>
<?php
		$counter++;
...
$navSep = "</div><div class='cell small-12 medium-auto'>";
$nextLinkText = "Next page";
$prevLinkText = "Previous page";
?>
	<div class="grid-x" id="post-archive-navigation">
		<div class="cell small-12 medium-auto">
	<?php posts_nav_link($navSep, $prevLinkText, $nextLinkText); ?>
		</div>
	</div>
<?php
else :
